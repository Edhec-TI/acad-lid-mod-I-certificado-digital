...
const PreTestForm = () => {
  ...
  const validateForm = () => {
    ...
    if (isNaN(idadeInt) || idadeInt < 1 || idadeInt > 99 || formData.idade.trim() === "") {
      toast({
  ...
  return <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="text-center mb-8">
        <div className="mb-6">
          <img alt="Academia de Líderes Logo" className="mx-auto h-20 md:h-24 mb-4" src="/lovable-uploads/158cdcd7-8c83-48fc-84e8-bc710f8da1d0.png" />
        </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input id="telefone" value={formData.telefone} onChange={e => handleInputChange('telefone', e.target.value)} placeholder="(XX)XXXXX-XXXX" className="bg-slate-700 border-slate-600 text-white" inputMode="numeric" maxLength={14} // máscara com pontuação = máx 14 chars
            required />
            ...
            <div>
              ...
              <Input id="cpf" value={formData.cpf} onChange={e => handleInputChange('cpf', e.target.value)} placeholder="XXX.XXX.XXX-XX" className="bg-slate-700 border-slate-600 text-white" inputMode="numeric" maxLength={14} // máscara com pontuação = máx 14 chars
            required />
            ...
            <div>
              ...
              <Input id="idade" value={formData.idade} onChange={e => handleInputChange('idade', e.target.value)} onBlur={e => {
            ...
            }} placeholder="Idade" className="bg-slate-700 border-slate-600 text-white" inputMode="numeric" maxLength={2} required />
            ...
            <div>
              ...
              <Select value={formData.uf} onValueChange={value => handleInputChange('uf', value)}>
                ...
                <SelectContent className="bg-slate-700 border-slate-600 z-50">
                  {BR_STATES.map(state => <SelectItem key={state.uf} value={state.uf} className="text-white">
                      {state.uf}
                    </SelectItem>)}
                </SelectContent>
              </Select>
            ...
            <div>
              ...
              <Select value={formData.estadoTreinamento} onValueChange={value => handleInputChange('estadoTreinamento', value)}>
                <SelectTrigger className="bg-slate-700 border-slate-600 text-white">
